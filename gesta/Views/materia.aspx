<%@ Page Language="C#" AutoEventWireup="true" CodeFile="materia.aspx.cs" Inherits="Views_materia" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarColor01">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="materia.aspx">Pesoas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="materia.aspx">Matérias <span class="sr-only">(current)</span></a>
                            </li>
                        </ul>
                        <div class="form-inline my-2 my-lg-0">
                            <asp:TextBox runat="server" ID="txtBuscar" placeholder="Código ou Nome" CssClass="form-control mr-sm-2"></asp:TextBox>
        ...
        <section>
            <div class="container">
                <asp:Panel ID="panelLista" runat="server" Visible="false">
                    ...
                    <asp:Table ID="listaMateria" runat="server" Width="100%" CssClass="table table-hover">
                        <asp:TableHeaderRow>
                ...
                <asp:Panel ID="panelRegistro" runat="server" Visible="false">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <small id="codigoHelp" class="form-text text-muted">Código de registro da materia/disciplina.</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small id="nomeHelp" class="form-text text-muted">Nome da matéria/disciplina envolvida/relacionada em alguma tarefa.</small>
                        </div>
